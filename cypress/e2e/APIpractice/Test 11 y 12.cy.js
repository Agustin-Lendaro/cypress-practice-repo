...
describe('POST To Create/Register User Account and DELETE METHOD To Delete User Account', () => {
    ...
    it('Test 12:Borra usario', () => {
        cy.request({
            ...
            body: {
                email: globalData.test1.email,
                password: globalData.test1.password
            }
